...
namespace mt
{
	...
	public:
		...
		bool Setup(int n)
		{
			...
			/*m_enemyships.push_back(new Asteroid);
			m_enemyships[0]->Setup(400, 400, 1, 0, "assets\\asteroid.png", 2.0f);

			m_enemyships.push_back(new Comet);
			m_enemyships[1]->Setup(400, 400, 1, 0, "assets\\comet.png", 2.0f);*/
